    ...
    <div class="row">
        <div class="col-lg-6 col-lg-offset-3">
        	<div class="row text-center">
				<h2><?php echo lang('users.register'); ?></h2>
			</div>
			<?php echo form_open('users/register', array('id' => 'ajaxform')); ?>
			...
			<div class="form-group">
			 	<div class="text-center">
					<button id="submit" name="submit" type="submit" class="btn btn-primary" value="1"><?php echo lang('users.add'); ?></button>
				</div>
			</div>
			<?php echo form_close(); ?>
